...
a = Analysis(
    ...
    hiddenimports=['PyQt5.QtCore', 'PyQt5.QtWidgets', 'PyQt5.QtGui', 'PyQt5.uic', 'sqlite3', 'settings_manager', 'db_access', 'db_pages', 'db_sections', 'db_version', 'media_store', 'ui_loader', 'ui_logic', 'ui_richtext', 'ui_sections', 'ui_tabs', 'ui_planning_register', 'left_tree', 'page_editor'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
